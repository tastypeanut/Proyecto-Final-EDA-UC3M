...
public class StudentsList implements IList {
	...
	/**
	 * adds a student at the beginning of the list. First, it checks that this
	 * student does not belong to the list.
	 */
	...
	/**
	 * adds a student at the end of the list. First, it checks that this student
	...
	/**
	 * inserts a student at the position index of the list. First, it checks that
	 * this student does not belong to the list.
	 */
	...
	/**
	 * returns the index of the student elem into the list. It returns -1 if the
	...
	/**
	 * returns the student at the position index. Returns null if the list does not
	...
	/**
	 * checks if the invoking list is the same that the input list. The order of the
